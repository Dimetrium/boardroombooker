<section id="main-content" class="clearfix">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <p><label><h4>Price <input type="text" name="price" value="<?= $_SESSION[ 'book_add' ][ 'price' ] ?>"></h4>
            </label></p>
        <table id="table_reg">
            <tr>
                <th>
                    <Label for='genre_title'><p id="btngenre">
                ...
                <th>
                    <Label for='author_title'><p id="btnauthor">

                        <h3>Author</h3></p></Label>
        ...
        <textarea name="full_text" cols="64" rows="20"
                  id="full_text"><?= $_SESSION[ 'book_add' ][ 'full_text' ] ?></textarea></p>
